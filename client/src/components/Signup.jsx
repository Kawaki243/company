  ...
  const register = (e) =>{
    ...
    axios.post("http://localhost:8080/register",{
      ...
      if(response.data.message){
        ...
        setRestatus("ACCOUNT CREATED SUCCESSFULLY");
      }
    })
  }
  let imgs = ['https://as2.ftcdn.net/v2/jpg/03/39/70/91/1000_F_339709132_H9HSSTtTmayePcbARkTSB2qoZTubJ6bR.jpg',];
  return (
                ...
                <div className="row d-flex justify-content-center align-items-center h-100">
                  <div className="col-md-8 col-lg-6 col-xl-4 offset-xl-1">
                    <form>
                      ...
                      <p><h1 style={{fontSize: '15px', textAlign: 'center', marginTop: '20px'}}>{restatus}</h1></p>
